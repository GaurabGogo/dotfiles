 ...
 -- user keys
  ...
  -- Restart AwesomeWM
    awful.key({ modkey, "Shift" }, "q", function () 
        awful.spawn("/home/gogo/dotfiles/scripts/power/session.sh") 
    end, {description = "Session", group = "session"}),
    
    -- Change Wallpaper
    awful.key({ modkey, "Shift" }, "w", function () 
        awful.spawn("/home/gogo/dotfiles/scripts/change_wallpaper.sh") 
    end, {description = "Change Wallpaper", group = "wallpaper"}),
    
    -- Lock Session
    awful.key({ modkey, "Control" }, "l", function () 
        awful.spawn("i3lock-fancy") 
    end, {description = "Lock Session", group = "lock"}),

    -- Clipboard
    awful.key({ modkey }, "b", function () 
        awful.spawn("/home/gogo/dotfiles/scripts/clipboard.sh") 
    end, {description = "Clipboard", group = "clip"}),
